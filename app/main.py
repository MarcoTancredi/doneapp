...
async def register_user_endpoint(
    ...
    print(f"DEBUG: Recebendo dados - username: {username}, email: {email}")
    ...
    print(f"DEBUG: Todos os dados recebidos:")
    ...
    print(f"  confirm_password length: {len(confirm_password) if confirm_password else 'None'}")

    print(f"  auth_sms: {auth_sms}")

    

    if password != confirm_password:

        print("DEBUG: Erro - senhas nao coincidem")
